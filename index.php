<?php
  ...
  $html = file_get_html('http://www.galant-biz.ru/rent/arenda_ofisov/');
				...
				<div class="row">
					...
					<div class="col-md-5 header_search_wrapper" >
						<div class="header_search">
							<span>Укажите желательную</span>
							<span>Площадь вашего офиса:</span>
			...
			<div class="row">
				<div class="col-md-3">
					<div class="advantage_wrapper">
						...
						<span>Комфорт</span>
						<span>Евроремонт, кондиционеры</span>
					</div>
				</div>
				<div class="col-md-3">
					<div class="advantage_wrapper">
						...
						<span>Географический центр города</span>
					</div>
				</div>
				<div class="col-md-3">
					<div class="advantage_wrapper">
						...
						<span>Три большие парковки</span>
					</div>
				</div>
				<div class="col-md-3">
					<div class="advantage_wrapper">
						...
						<span>Автобусы, маршрутки, трамваи</span>
					</div>
				</div>
			</div>	
			<div class="row advantage_bottom_row">
				...
				<div class="col-md-3">
					<div class="advantage_wrapper">
						...
						<span>Склады</span>
						<span>И офисы - в одном месте</span>
					</div>
				</div>
				<div class="col-md-3">
					<div class="advantage_wrapper">
						...
						<span>Уборка</span>
						<span>Входит в стоимость аренды</span>
					</div>
				</div>
			</div>
		</div>
